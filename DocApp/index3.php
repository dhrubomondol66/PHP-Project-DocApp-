...
if (!isset($_SESSION['user_id'])) {
    header("Location: Doctors_profile.php"); // Redirect to login if not logged in
    exit();
}
...
$mysqli = include('db.php'); // Adjust the path if necessary

// Use COUNT() to get the total number of doctors registered
...
.total-doctors {
    ...
    margin: 20px auto; /* Add some spacing around the text */
    ...
    <header class = "header bg-blue">
        ...
        <div class="user-container">
            <a href="Doctors_profile.php" class="user-btn">
                <img src="images/Doctor_icon.jpg" alt="Doctor Icon" class="user-icon">
                <?php echo $doctorusername; ?>
            </a>
        </div>
            ...
            <div class = "container grid">
                ...
                <div class = "banner-two-right">
                    ...
                    <div class = "btn-group">
                        ...
                        <a href = "Doc-profile.php" class = "btn btn-light-blue" >Doctors_list</a>
                    </div>
                </div>
            </div>
        </section>
