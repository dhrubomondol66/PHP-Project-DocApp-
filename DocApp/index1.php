        ...
        <div class = "header-inner text-white text-center">
            <div class = "container grid">
                <div class = "header-inner-left">
                    ...
                    <div class = "btn-group">
                        <a href="Log_In.php" class="btn btn-white">Log In</a>
                        <a href="Sign_up.php" class="btn btn-light-blue">Sign Up</a>
                    </div>
                </div>
        ...
        <section id = "banner-two" class = "banner-two text-center">
            <div class = "container grid">
                ...
                <h2>Doctor Register Panel</h2>
                    ...
                    <div class = "btn-group">
                        <a href = "#" class = "btn btn-white">Learn More</a>
                        <a href = "Signup(doc).php" class = "btn btn-light-blue" >Sign In</a>
                    </div>
                </div>
            </div>
        </section>
